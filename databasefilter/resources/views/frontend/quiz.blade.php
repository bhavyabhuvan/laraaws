...
<div class="content-body-w">
    ...
    <div class="container-fluid new1">
        ...
        <div class="row">
            ...
            <div class="col m3 s6">
                <div class="input-field col s12">
                    <select id="subject" class="subject_list" name="subject">
                ...
                <a target="_blank"
                    ...
                    <div class="col s6 m4 result-card-div">
                        <div class="result-card g-bg">
                            ...
                            <div class="comic-hd">
                                <h6 class="g-txt center comic-title"><b>{{ $quiz->comic_name }}</b></h6>
                                <p class="sec-txt center explr">Topic {{ $quiz->topic }}</p>
                            </div>
                        </div>
                    </div>
                </a>
